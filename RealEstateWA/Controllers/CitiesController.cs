...
namespace RealEstateWA.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(DbRealEstateContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Cities != null ?
                        ...
                        Problem("Entity set 'DbRealEstateContext.Cities'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // return View(city);
            return RedirectToAction("Index", "Locations", new { id = city.Id });
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbRealEstateContext.Cities'  is null.");
            }
            var city = await _context.Cities.FindAsync(id);
            if (city != null)
            {
